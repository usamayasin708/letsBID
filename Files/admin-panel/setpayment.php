...
<h2><i class="fa fa-money"></i> Deposit Method Setting </h2>
</div>
...
$cc1 = mysqli_fetch_array(mysqli_query($conms,"SELECT COUNT(*) FROM deposit_method WHERE id='1'"));
if ($cc1[0]==0) {
mysqli_query($conms,"INSERT INTO deposit_method SET id='1'");
}

$cc2 = mysqli_fetch_array(mysqli_query($conms,"SELECT COUNT(*) FROM deposit_method WHERE id='2'"));
if ($cc2[0]==0) {
mysqli_query($conms,"INSERT INTO deposit_method SET id='2'");
}

$cc3 = mysqli_fetch_array(mysqli_query($conms,"SELECT COUNT(*) FROM deposit_method WHERE id='3'"));
if ($cc3[0]==0) {
mysqli_query($conms,"INSERT INTO deposit_method SET id='3'");
}

$cc4 = mysqli_fetch_array(mysqli_query($conms,"SELECT COUNT(*) FROM deposit_method WHERE id='4'"));
if ($cc4[0]==0) {
mysqli_query($conms,"INSERT INTO deposit_method SET id='4'");
}
...
$res1 = mysqli_query($conms,"UPDATE deposit_method SET name='".$name1."', minamo='".$min1."', maxamo='".$max1."', charged='".$cd1."', chargep='".$cp1."', rate='".$rate1."', val1='".$val11."', val2='".$val11."', status='".$st1."' WHERE id='1'");

$res2 = mysqli_query($conms,"UPDATE deposit_method SET name='".$name2."', minamo='".$min2."', maxamo='".$max2."', charged='".$cd2."', chargep='".$cp2."', rate='".$rate2."', val1='".$val21."', val2='".$val22."', status='".$st2."' WHERE id='2'");

$res3 = mysqli_query($conms,"UPDATE deposit_method SET name='".$name3."', minamo='".$min3."', maxamo='".$max3."', charged='".$cd3."', chargep='".$cp3."', rate='".$rate3."', val1='".$val31."', val2='".$val32."', status='".$st3."' WHERE id='3'");

$res4 = mysqli_query($conms,"UPDATE deposit_method SET name='".$name4."', minamo='".$min4."', maxamo='".$max4."', charged='".$cd4."', chargep='".$cp4."', rate='".$rate4."', val1='".$val41."', val2='".$val42."', status='".$st4."' WHERE id='4'");
...
$old1 = mysqli_fetch_array(mysqli_query($conms,"SELECT name, rate,  minamo, maxamo, charged, chargep, val1, val2, status FROM deposit_method WHERE id='1'"));
$old2 = mysqli_fetch_array(mysqli_query($conms,"SELECT name, rate,  minamo, maxamo, charged, chargep, val1, val2, status FROM deposit_method WHERE id='2'"));
$old3 = mysqli_fetch_array(mysqli_query($conms,"SELECT name, rate,  minamo, maxamo, charged, chargep, val1, val2, status FROM deposit_method WHERE id='3'"));
$old4 = mysqli_fetch_array(mysqli_query($conms,"SELECT name, rate,  minamo, maxamo, charged, chargep, val1, val2, status FROM deposit_method WHERE id='4'"));
...
<div class="col-md-3">
<img src="<?php echo $baseurl; ?>/assets/images/deposit-method/method1.jpg" alt="Display Image" style="width: 100%;">
</div>
...
<div class="col-md-3">
<img src="<?php echo $baseurl; ?>/assets/images/deposit-method/method2.jpg" alt="Display Image" style="width: 100%;">
</div>
...
<div class="form-group">
<label class="col-md-12"><strong style="text-transform: uppercase;">PM USD ACCOUNT</strong></label>
<div class="col-md-12">
...
<div class="col-md-3">
<img src="<?php echo $baseurl; ?>/assets/images/deposit-method/method3.jpg" alt="Display Image" style="width: 100%;">
</div>
...
<div class="col-md-3">
<img src="<?php echo $baseurl; ?>/assets/images/deposit-method/method4.jpg" alt="Display Image" style="width: 100%;">
</div>
...
<div class="row">
<div class="col-md-12">
<button type="submit" class="btn btn-success btn-block btn-lg">UPDATE SETTING</button>
<br>
<br>
<br>
</div>
